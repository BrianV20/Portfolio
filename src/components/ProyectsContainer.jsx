...
export default function ProyectsContainer(){
    ...
    return (
        <div className="border-y-2 mt-8 border-slate-200 rounded-lg py-4 px-4 md:px-6 lg:px-8" id="proyects">
            <div className="bg-violet-100 rounded-lg px-4 py-2 mb-4">
                <p className="text-xl md:text-2xl  text-violet-700 roboto-bold">Proyectos</p>
            </div>
